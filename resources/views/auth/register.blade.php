...
<div class="container">
               ...
               @section ('login_panel_body')
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('utc') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                            <select id="utc" class="form-control" name="utc" required>
	...
	<option timeZoneId="68" gmtAdjustment="GMT+08:00" useDaylightTime="0" value="8" selected>(GMT+08:00) Taipei</option>
